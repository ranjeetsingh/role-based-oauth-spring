...
INSERT INTO users (email,first_name, last_name,password,username) values ('admin@gmail.com','admin', 'admin','$2a$10$sXTSLwfcjqhjsdek87KkMOzaL8jZtMR7P10e5bgStLkw2SF9jfOe6','admin');
